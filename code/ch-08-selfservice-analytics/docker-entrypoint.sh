...
# ttyd runs the restricted launcher: SHELL=noshell blocks dropping to a raw shell, -W makes the terminal writable, -a forwards ?arg=<user> to launch-claude as $1.

...
AGENT_SYSTEM = (
    ...
    " six-factor rating scorecard, and the credit policy. Using only that"
    " retrieved guidance, grade the six factors (financial strength; political"
    " and legal environment; transaction characteristics; strength of sponsor;"
    " security package; climate and transition) and map the result to an"
    " internal risk profile from 1 to 10,"
